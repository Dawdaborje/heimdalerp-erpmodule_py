...
class Account(models.Model):
    ...
    code = models.SlugField(_("code"), max_length=30)
    name = models.CharField(_("name"), max_length=150)
    account_type = models.CharField(
        _("main type"), max_length=1, choices=ACCOUNT_TYPES, blank=True, null=True
    )
    balance = models.DecimalField(
        _("balance"), max_digits=20, decimal_places=2, default=0.00
    )

    def __str__(self):
        return _noop("%(code)s %(name)s") % {"code": self.code, "name": self.name}
...
class Transaction(models.Model):
    ...
    debit_account_balance = models.DecimalField(
        _("account balance"), max_digits=20, decimal_places=2
    )
    ...
    credit_account_balance = models.DecimalField(
        _("credit account balance"), max_digits=20, decimal_places=2
    )
